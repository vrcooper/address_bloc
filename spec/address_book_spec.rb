...
context ".import_from_csv" do
       ...
       ## additional entries
        ...
        it "imports the 1st entry" do
            ...
            check_entry(entry_one, "Virginia", "330-389-2571", "vcooper_us@yahoo.com")
            expect(entry_one.name).to eql "Virginia"
            expect(entry_one.phone_number).to eql "330-389-2571"
    ...
    # Test the binary_search method
        ...
        context "#binary_search" do
            ...
            it "search AddressBook for Joe" do
                book.import_from_csv("entries.csv")
            ...
            it "search AddressBook for Sally" do
                book.import_from_csv("entries.csv")
            ...
            it "search AddressBook for Sussie" do
                book.import_from_csv("entries.csv")
